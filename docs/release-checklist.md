# WP Definitivo 1.0.54 release checklist
...
- [ ] `readme.txt`, POT, screenshot, GPL license, and changelog match version 1.0.54.
...
- [ ] Leandro Biffi completes final RC acceptance and explicitly approves the 1.0.54 ZIP.
