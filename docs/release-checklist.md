# WP Definitivo 1.0.56 release checklist
...
- [ ] `readme.txt`, POT, screenshot, GPL license, and changelog match version 1.0.56.
...
- [ ] Leandro Biffi completes final RC acceptance and explicitly approves the 1.0.56 ZIP.
